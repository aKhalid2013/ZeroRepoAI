...
- **Reminder**: After updating gate statuses, run `./scripts/agent.sh --update-status <status> --update-step <step>` to refresh the Current Feature Progress and Change Log entries.
